...
## 📥 Download da Última Versão: `v2.5.109`

- 📦 **Instalador Executável Direto**: [Baixar MEMO-Desktop-Setup-v2.5.109.exe](https://github.com/hermannhahn/memo-desktop/releases/download/v2.5.109/MEMO-Desktop-Setup-v2.5.109.exe)
- 📦 **Instalador de Compatibilidade (AI-Brain)**: [Baixar AI-Brain-Setup-v2.5.109.exe](https://github.com/hermannhahn/memo-desktop/releases/download/v2.5.109/AI-Brain-Setup-v2.5.109.exe)
- ⚡ **Instalador Automatizado Windows (Recomendado)**: [Baixar install-memo.bat](https://github.com/hermannhahn/memo-desktop/releases/download/v2.5.109/install-memo.bat)
- 📄 **Script PowerShell**: [Baixar install-memo.ps1](https://github.com/hermannhahn/memo-desktop/releases/download/v2.5.109/install-memo.ps1)
- 🔐 **Script de Certificado**: [Baixar install-cert.bat](https://github.com/hermannhahn/memo-desktop/releases/download/v2.5.109/install-cert.bat)
- 📄 **Certificado Digital**: [Baixar AIBrainDevCert.crt](https://github.com/hermannhahn/memo-desktop/releases/download/v2.5.109/AIBrainDevCert.crt)
...
1. Baixe o instalador [`install-memo.bat`](https://github.com/hermannhahn/memo-desktop/releases/download/v2.5.109/install-memo.bat).
...
1. Baixe o instalador [`MEMO-Desktop-Setup-v2.5.109.exe`](https://github.com/hermannhahn/memo-desktop/releases/download/v2.5.109/MEMO-Desktop-Setup-v2.5.109.exe).
...
1. Baixe os arquivos [`AIBrainDevCert.crt`](https://github.com/hermannhahn/memo-desktop/releases/download/v2.5.109/AIBrainDevCert.crt) e [`install-cert.bat`](https://github.com/hermannhahn/memo-desktop/releases/download/v2.5.109/install-cert.bat) na mesma pasta.
