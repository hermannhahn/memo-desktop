...
## 📥 Download da Última Versão: `v2.6.103-alpha`

- 📦 **Instalador Executável Direto**: [Baixar MEMO-Desktop-Setup-v2.6.103-alpha.exe](https://github.com/hermannhahn/memo-desktop/releases/download/v2.6.103-alpha/MEMO-Desktop-Setup-v2.6.103-alpha.exe)
- ⚡ **Instalador Automatizado Windows (Recomendado)**: [Baixar install-memo.bat](https://github.com/hermannhahn/memo-desktop/releases/download/v2.6.103-alpha/install-memo.bat)
- 📄 **Script PowerShell**: [Baixar install-memo.ps1](https://github.com/hermannhahn/memo-desktop/releases/download/v2.6.103-alpha/install-memo.ps1)
- 🔐 **Script de Certificado**: [Baixar install-cert.bat](https://github.com/hermannhahn/memo-desktop/releases/download/v2.6.103-alpha/install-cert.bat)
- 📄 **Certificado Digital**: [Baixar AIBrainDevCert.crt](https://github.com/hermannhahn/memo-desktop/releases/download/v2.6.103-alpha/AIBrainDevCert.crt)
...
1. Baixe o instalador [`install-memo.bat`](https://github.com/hermannhahn/memo-desktop/releases/download/v2.6.103-alpha/install-memo.bat).
...
1. Baixe o instalador [`MEMO-Desktop-Setup-v2.6.103-alpha.exe`](https://github.com/hermannhahn/memo-desktop/releases/download/v2.6.103-alpha/MEMO-Desktop-Setup-v2.6.103-alpha.exe).
...
1. Baixe os arquivos [`AIBrainDevCert.crt`](https://github.com/hermannhahn/memo-desktop/releases/download/v2.6.103-alpha/AIBrainDevCert.crt) e [`install-cert.bat`](https://github.com/hermannhahn/memo-desktop/releases/download/v2.6.103-alpha/install-cert.bat) na mesma pasta.
...
### 🌟 Notas do Release v2.6.103-alpha:
