...
## 📥 Download da Última Versão: `v2.5.68`

- 📦 **Instalador Executável Direto**: [Baixar AI-Brain-Setup-v2.5.68.exe](https://github.com/hermannhahn/ai-brain-desktop/releases/download/v2.5.68/AI-Brain-Setup-v2.5.68.exe)
- ⚡ **Instalador Automatizado Windows (Recomendado)**: [Baixar install-ai-brain.bat](https://github.com/hermannhahn/ai-brain-desktop/releases/download/v2.5.68/install-ai-brain.bat)
- 📄 **Script PowerShell**: [Baixar install-ai-brain.ps1](https://github.com/hermannhahn/ai-brain-desktop/releases/download/v2.5.68/install-ai-brain.ps1)
- 🔐 **Script de Certificado**: [Baixar install-cert.bat](https://github.com/hermannhahn/ai-brain-desktop/releases/download/v2.5.68/install-cert.bat)
- 📄 **Certificado Digital**: [Baixar AIBrainDevCert.crt](https://github.com/hermannhahn/ai-brain-desktop/releases/download/v2.5.68/AIBrainDevCert.crt)
...
1. Baixe o instalador [`install-ai-brain.bat`](https://github.com/hermannhahn/ai-brain-desktop/releases/download/v2.5.68/install-ai-brain.bat).
...
1. Baixe o instalador [`AI-Brain-Setup-v2.5.68.exe`](https://github.com/hermannhahn/ai-brain-desktop/releases/download/v2.5.68/AI-Brain-Setup-v2.5.68.exe).
...
1. Baixe os arquivos [`AIBrainDevCert.crt`](https://github.com/hermannhahn/ai-brain-desktop/releases/download/v2.5.68/AIBrainDevCert.crt) e [`install-cert.bat`](https://github.com/hermannhahn/ai-brain-desktop/releases/download/v2.5.68/install-cert.bat) na mesma pasta.
