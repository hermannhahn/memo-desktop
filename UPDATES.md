...
#### ✨ Novidades
- updates for release v2.6.103-alpha (`5926604`)
- updates in feature/builtin-subagent-skill-and-db-sync-fix (`f1cb475`)

#### 📚 Documentação
- mark Phase 112 as completed (`5d001d7`)
- add phases 112-115 for subagents, lazy mcp, symbols, and sleep deduplication (`ef024a5`)
...
#### ✨ Novidades
- updates for release v2.6.95-alpha (`656a195`)
- next-gen deep research engine with reflective multi-hop loop, knowledge base full doc ingestion, and publication dossiers (`0d64a4e`)
...
#### ✨ Novidades
- updates for release v2.6.87-alpha (`223ab29`)
- update development branch (`0530c60`)
- integrate bring-your-own-tool architecture, app hub card and clean env resolution (`1347e3b`)

#### 🐛 Correções
- enforce per-agent LLM credentials and eliminate global key fallback in sleep model (`342239b`)
...
#### ✨ Novidades
- updates for release v2.6.73-alpha (`ec7b262`)
- update development branch (`ff25bdb`)
- add extended filter options (scope, domains, file_types, max_sub_queries, limit, time_range, language) to deep_research tool (`0c889b1`)
- add docx, doc, xlsx, csv support and research domain filters (`4737f6e`)

#### 📚 Documentação
- document Phase 82 multi-format knowledge base, domain filters, and integrations (`6b95089`)
...
**Total:** 13 alteração(ões) acumulada(s) desde a última release.

#### ✨ Novidades
- updates for release v2.6.66-alpha (`f3528cf`)
- update settings telemetry codes and set 1d filter default in dashboard (`a08f888`)

#### 🐛 Correções
- relocate whatsapp to optional services, update hud badges and clean kokoro meta (`11f7ab5`)
- update HUD card badges to BKP-M, RES-M, BKP-C, RES-C and routine code (`bd1da59`)
- ensure Windows file and folder dialogs open in foreground (`956d3de`)
- standardize button labels to Run Backup Now and Backup Folder (`7643c36`)
- add accent border to filter panels and replace broken settings icon (`8ff9ec7`)
- resolve agent display name in footer chip and align page-size (`d197367`)
- optimize filter badge position, status icon column and table layout (`14cf1fa`)
- remove eliminated from lifecycle chart and default neutral emotion to unchecked (`d887a20`)
- update X-Title header to MEMOROUTER (`91a8878`)
- skill i18n escopada exclusivamente ao desenvolvimento, eliminado portunhol e separadas claramente as regras de codigo das regras de interacao (`ebf974a`)

#### 📚 Documentação
- prepare patch_msg.txt for openrouter header update (`b305c3b`)
...
#### ✨ Novidades
- updates for release v2.6.44-alpha (`19f45ed`)
...
#### ✨ Novidades
- updates for release v2.6.41-alpha (`38f61fa`)
- update development branch (`68efcfa`)

#### 🐛 Correções
- auto-sync database schema and migrations after backup restore (`d5ed982`)
...
#### ✨ Novidades
- updates for release v2.6.37-alpha (`ed88656`)
...
#### ✨ Novidades
- updates for release v2.5.118 (`8a538e5`)
